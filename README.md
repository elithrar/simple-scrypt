...
- [x] Automatically calculate "optimal" values for N, r, p similar [to the Ruby scrypt library](https://github.com/pbhogan/scrypt/blob/master/lib/scrypt.rb#L97-L146) 
   e.g. `func Calibrate(duration int, mem int) (Params, error)`. Thanks to @tgulacsi 
   for submitting a PR that iteratively determines suitable params within time/memory 
   limits.
